...
if __name__ == "__main__":
    ...
    # Password for accessing the Cryosat FTP server : 
    # Username : anonymous ; Password : your mail adress
    password = None

    # Step 1 : Extract PSEP
    # /!\ Make sure you downloaded the txt file required before running (cf ReadMe)
    extract_psep(path, year, month, password=password)
    ...
    plot_rsr_results(path, year, month, latlon_target_list=[(72.09971834404213,-62.87869659584134)])  # You can provide a list of target lat/lon pairs to plot their distributions